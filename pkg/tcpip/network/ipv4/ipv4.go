...
func (e *endpoint) WritePacket(r *stack.Route, gso *stack.GSO, params stack.NetworkHeaderParams, pkt *stack.PacketBuffer) *tcpip.Error {
	...
	if pkt.NatDone {
		...
		if err == nil {
			...
			ep.HandlePacket(route.PacketInfo(), pkt)
			return nil
		}
	}
	...
	if r.Loop&stack.PacketLoop != 0 {
		...
		e.HandlePacket(loopedR.PacketInfo(), pkt)
		loopedR.Release()
	}
...
func (e *endpoint) WriteHeaderIncludedPacket(r *stack.Route, pkt *stack.PacketBuffer) *tcpip.Error {
	...
	if r.Loop&stack.PacketLoop != 0 {
		e.HandlePacket(r.PacketInfo(), pkt.Clone())
	}
	if r.Loop&stack.PacketOut == 0 {
		return nil
	}
	...
	return e.linkEP.WritePacket(r.PacketInfo(), nil /* gso */, ProtocolNumber, pkt)
}

// HandlePacket is called by the link layer when new ipv4 packets arrive for
// this endpoint.
func (e *endpoint) HandlePacket(r stack.NetworkPacketInfo, pkt *stack.PacketBuffer) {
	if !e.isEnabled() {
		return
	}
	...
	//   multicast address).
	if r.Broadcast || header.IsV4MulticastAddress(r.RemoteAddress) {
