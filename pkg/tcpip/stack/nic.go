...
func (n *NIC) handlePacket(protocol tcpip.NetworkProtocolNumber, dst, src tcpip.Address, remotelinkAddr tcpip.LinkAddress, addressEndpoint AssignableAddressEndpoint, pkt *PacketBuffer) {
	...
	addressEndpoint.NetworkEndpoint().HandlePacket(r.PacketInfo(), pkt)
}
...
// protocol endpoint.
func (n *NIC) DeliverTransportPacket(r NetworkPacketInfo, protocol tcpip.TransportProtocolNumber, pkt *PacketBuffer) TransportPacketDisposition {
