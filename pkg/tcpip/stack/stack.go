...
type transportProtocolState struct {
	...
	defaultHandler func(r NetworkPacketInfo, id TransportEndpointID, pkt *PacketBuffer) bool
}
...
func (s *Stack) SetTransportProtocolHandler(p tcpip.TransportProtocolNumber, h func(NetworkPacketInfo, TransportEndpointID, *PacketBuffer) bool) {
