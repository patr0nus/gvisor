...
func (d *dispatcher) queuePacket(r stack.NetworkPacketInfo, stackEP stack.TransportEndpoint, id stack.TransportEndpointID, pkt *stack.PacketBuffer) {
	ep := stackEP.(*endpoint)

	// TODO: This is a workaround
	route, err := ep.stack.FindRoute(r.LinkPacketInfo.NICID, r.LocalAddress, r.RemoteAddress, r.LinkPacketInfo.NetProto, false /* multicastLoop */)
	if err != nil {
		return
	}
