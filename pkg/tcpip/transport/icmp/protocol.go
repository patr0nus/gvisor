...
func (*protocol) HandleUnknownDestinationPacket(stack.NetworkPacketInfo, stack.TransportEndpointID, *stack.PacketBuffer) stack.UnknownDestinationPacketDisposition {
